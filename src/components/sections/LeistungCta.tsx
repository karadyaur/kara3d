        ...
        >
          ...
          <motion.div variants={fadeUp} className="w-full md:flex-1 flex flex-col gap-8 items-center md:items-start text-center md:text-left">
            <div className="flex flex-col gap-6 max-w-[600px]">
              ...
              <p className="font-sans font-normal text-medium-body text-white leading-[1.5]">
                {description}
              </p>
            </div>
          ...
          <motion.div variants={imageReveal} className="w-full md:flex-1 relative rounded-4xl md:rounded-5xl overflow-hidden aspect-[600/400] md:aspect-[500/360]">
            <Image
              src={image}
              alt={imageAlt}
              fill
